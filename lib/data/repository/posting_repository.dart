...
import 'package:pamlanjut_restapi/data/model/request/admin/posting_jual_request_model.dart';
import 'package:pamlanjut_restapi/data/model/response/burung_semua_tersedia_model.dart';
import 'package:pamlanjut_restapi/data/model/response/get_all_burung_response_model.dart';
...
class PostingRepository {
  ...
  Future<Either<String, BurungSemuaTersediabyIdModel>> addPostBurung(
    ...
    try {
      ...
      return Left("An error occured while post burung: $e");
    }
  }
