...
import 'package:pamlanjut_restapi/data/repository/auth_repository.dart';
import 'package:pamlanjut_restapi/data/repository/get_all_burung_tersedia_repository.dart';
import 'package:pamlanjut_restapi/data/repository/profile_buyer_repository.dart';
import 'package:pamlanjut_restapi/presentation/auth/bloc/login/login_bloc.dart';
import 'package:pamlanjut_restapi/presentation/auth/bloc/register/register_bloc.dart';
...
import 'package:pamlanjut_restapi/presentation/buyer/profile/bloc/profile_buyer_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => 
            GetBurungTersediaBloc(GetAllBurungTersediaRepository(ServiceHttpClient())),
          ),
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
